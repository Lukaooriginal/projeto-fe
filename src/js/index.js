...
Objetivo 1 - quando o usuário clicar no botão de seleção de plataformas deve abrir uma caixa com os botões de seleção de plataforma
         ...
         Passo 4 - quando o ususário clicar, adicionar a classe ativo na listagem de plataformas dentro do botão para que o conteúdo apareça
...
//Passo 1 - pegar o botão de seleção de plataforma no JS para poder verificar quando o usuário clicar em cima dele
const botao = document.querySelector(".botao-sociais");

const elementoPlataformas = document.querySelector(".botao-sociais .plataformas");
